...
public abstract class Operators {
    ...
    private static final int        INDEX_GT             = 8;
    private static final int        INDEX_GTE            = 9;
    private static final int        INDEX_LT             = 10;
    private static final int        INDEX_LTE            = 11;
    
    private static final Operator[] builtinOperators     = new Operator[12];
    ...
    static {
        ...
        builtinOperators[INDEX_GT] = new Operator(">", 2, true, Operator.PRECEDENCE_ADDITION - 1) {
            
            public double apply(final double... args) {
                
                return args[0] - args[1] > 0 ? 1 : 0;
                
            }
        };
        builtinOperators[INDEX_GTE] = new Operator(">=", 2, true, Operator.PRECEDENCE_ADDITION - 1) {
        ...
        builtinOperators[INDEX_LT] = new Operator("<", 2, true, Operator.PRECEDENCE_ADDITION - 1) {
        ...
        builtinOperators[INDEX_LTE] = new Operator("<=", 2, true, Operator.PRECEDENCE_ADDITION - 1) {
    ...
    public static Operator getBuiltinOperator(final String symbol, final int numArguments) {
        ...
        switch (symbol) {
            ...
            case ">":
                return builtinOperators[INDEX_GT];
            case "<":
                return builtinOperators[INDEX_LT];
            case ">=":
                return builtinOperators[INDEX_GTE];
            case "<=":
                return builtinOperators[INDEX_LTE];
