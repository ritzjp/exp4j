...
public abstract class Operator {
     ...
     *            the number of operands the operator takes (1 or 2)
     * @param leftAssociative
     *            set to true if the operator is left associative, false if it
     ...
     * @param ch
     *            the char to check
     * @return true if the char is allowed an an operator symbol, false
     *         otherwise
     */
